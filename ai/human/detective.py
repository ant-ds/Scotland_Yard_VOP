...
#             # detective already on a metro station -> make a little loop (graph cycle)
#             if len(path) == 1: 
#                 print(nx.find_cycle(self.game.board.graph,source=path[0]))
#                 # neighbours = self.game.board.getOptions(self.game.detectives[i], customStartPosition = path[0])
#                 # transportToUse = "taxi"
#                 # chosen = False
#                 # for trial in neighbours:
#                 #     trialneighbours = self.game.board.getOptions(self.game.detectives[i], customStartPosition = trial[0])
#                 #     for neighbour in neighbours:
#                 #         for match in trialneighbours if match[0] == neighbour[0]:
#                 #             print("match!")
#                 #             chosen = True
...
#                 path.append(random.choice([viable for viable in neighbours if viable[1] is transportToUse]))
